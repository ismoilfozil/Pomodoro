package uz.xteam.pomodoro.helper
...
abstract class SharedPreferenceHelper(context: Context, preferences: SharedPreferences? = null, prefName:String = "LocalStorage") {
    val pref = preferences ?: context.getSharedPreferences(prefName, Context.MODE_PRIVATE)
    ...
    inner class booleans(private val init: Boolean = false) : ReadWriteProperty<SharedPreferenceHelper, Boolean> {
        ...
        override fun setValue(thisRef: SharedPreferenceHelper, property: KProperty<*>, value: Boolean) =
